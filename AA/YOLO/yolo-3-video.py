...
"""
# Prohibición : circular Traffic Signs with white background and red border line
# Peligro: triangular Traffic Signs with white background and red border line
# Obligación: circular Traffic Signs with blue background
# Otros: rest
...
videoName = 'signal'
video = cv2.VideoCapture('videos/'+ videoName + '.mp4')
...
# r'yolo-coco-data\yolov3.cfg' or 'yolo-coco-data\\yolov3.cfg'
# r'yolo-coco-data\yolov3.weights' or yolo-coco-data\\yolov3.weights'
## Cargamos la red ya entrenada de YOLO 3, su configuración y pesos
network = cv2.dnn.readNetFromDarknet('yolo-coco-data/yolov3_ts_test.cfg',
                                     'yolo-coco-data/yolov3_ts.weights')
...
while True:
    ...
    if writer is None:
        ...
        videoName = videoName + '-RESULTADO'
        writer = cv2.VideoWriter('videos/'+ videoName + '.mp4', fourcc, 30, (frame.shape[1], frame.shape[0]), True)
