...
full_path_to_images = '/Users/oscarmartincasares/IA/4_Entrenamiento/traffic_signals'
...
# to this: + '\' +
# or to this: + '\\' +
with open(full_path_to_images + '/' + 'traffic_signals_data.data', 'w') as data:
...
"""
End of:
Creating file traffic_signals_data.data
"""
