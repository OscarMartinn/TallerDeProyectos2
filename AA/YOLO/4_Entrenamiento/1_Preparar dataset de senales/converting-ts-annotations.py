...
full_path_to_ts_dataset = '/Users/oscarmartincasares/IA/4_Entrenamiento/traffic_signals'
...
# Automatizamos la creación de este fichero
file_classes_txt = full_path_to_ts_dataset + '/classes.txt'
with open(file_classes_txt,'w') as file:
    file.write("prohibitory\n")
    file.write("danger\n")
...
for current_dir, dirs, files in os.walk('.'):
    ...
    for f in files:
        ...
        if f.endswith('.ppm'):
            ...
            # Borramos los bitmaps de las imágenes ppm que ya no nos hacen falta
            path_to_remove_ppms = full_path_to_ts_dataset + '/' + image_name + '.ppm'
            os.remove(path_to_remove_ppms)
