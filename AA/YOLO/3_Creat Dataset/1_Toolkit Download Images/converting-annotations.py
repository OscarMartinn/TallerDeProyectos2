...
full_path_to_csv = '/Users/oscarmartincasares/IA/Creat Dataset/Toolkit Download Images/OIDv4_ToolKit/OID/csv_folder'
...
full_path_to_images = \
    '/Users/oscarmartincasares/IA/Creat Dataset/Toolkit Download Images/OIDv4_ToolKit/OID/Dataset/train/Car_Bus'
...
file_with_classes = '/classes.txt'
where_to_write_file = full_path_to_images + file_with_classes
with open(where_to_write_file, 'w') as file:
    for label in labels:
        file.write(label)
        file.write("\n")
file.close()
